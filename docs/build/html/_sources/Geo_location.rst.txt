...
---------------------------------
This function essentially uses **geo_model()** to make the actual prediction. We talk more about this later. This function also depends
on several other modules to get the actual data like - **get_weatherInfo()** and **make_sample_features()**
...
--------------------
This function uses all the processed weather data like *temperature* , *wind-speed*, *precipitation*
.. automodule:: src.utils
   :members: get_weatherInfo

1.4 Make Sample Features
------------------------

.. automodule:: src.utils
   :members: make_sample_features
...
This **geo_model** uses **cluster_model.py** for training and testing. More about this module can be found :ref:`here <cluster_model_marker>`.